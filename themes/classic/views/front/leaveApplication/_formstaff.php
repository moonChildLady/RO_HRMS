...
<?php echo $form->dropDownListGroup(
	...
	$datetime4 = new DateTime('2019-09-30');
	$interval5 = $datetime4->diff($datetime3);
	...
	if($type=="130"){
		...
		//$interval = $interval1->format('-%ad');
		/* if(date('m', strtotime($modelUser->staffCode0->dob)) > (date('m')+1)){
			$interval = $interval1->format('+%ad');
		}else{
			$interval = $interval1->format('-%ad');
		} */
		/* if(date('m', strtotime($modelUser->staffCode0->dob)) >= date('m')){
			...
			if(date('m', strtotime($modelUser->staffCode0->dob)) == date('m')){
				...
				$interval = $interval1->format('+%ad');
				echo date('m', strtotime($modelUser->staffCode0->dob));
			}
