...
/**
 * This is the model class for table "DeptHead".
 *
 * The followings are the available columns in table 'DeptHead':
 * @property integer $id
 ...
 */
class DeptHead extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, staffCode, deptID, active', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return DeptHead the static model class
	 */
