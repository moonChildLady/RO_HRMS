...
class Attachments extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('fileLocation', 'required'),
			array('fileLocation', 'length', 'max'=>300),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, createDate, fileLocation', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'leaveApplications' => array(self::HAS_MANY, 'LeaveApplication', 'attachmentID'),
		);
	}
