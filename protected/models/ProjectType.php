...
class ProjectType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('projectID, typeID', 'required'),
			array('projectID, typeID', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, projectID, typeID', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'type' => array(self::BELONGS_TO, 'wwwContentTable', 'typeID'),
		);
	}
