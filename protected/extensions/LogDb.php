...
class LogDb extends CDbLogRoute{
    ...
    /* protected function processLogs($logs)
    {
        ...
        foreach($logs as $log)
        {
            $command->insert($this->logTableName,array(
                ...
                'user_name'=>Yii::app()->user->staffCode, //Get name
    ...
    {
        $command=$this->getDbConnection()->createCommand();
        /* $message='User: '.Yii::app()->user->staffCode.Yii::app()->user->fullname.' From IP: '.Yii::app()->request->userHostAddress.' on: '.Yii::app()->request->url; */
